#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Timestamp: "2025-06-09 00:06:52 (ywatanabe)"
...
def test_pac_speed():
    ...
    assert results["surrogates"] is None  # Should be None to save memory
