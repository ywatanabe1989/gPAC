...
# --------------------------------------------------------------------------------
# Start of Source Code from: /home/ywatanabe/proj/gPAC/src/gpac/_Filters/_TrainableBandPassFilter.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
# 
...
#         
#         # Don't initialize kernels here - they'll be created dynamically
# 
...
#         """
#         Apply trainable bandpass filtering.
#         Kernels are rebuilt on each forward pass to reflect current parameters.
#         """
#         # Always rebuild kernels to reflect current parameter values
#         if hasattr(self, 'kernels'):
#             delattr(self, 'kernels')
#         
...
#         }
# --------------------------------------------------------------------------------
# End of Source Code from: /home/ywatanabe/proj/gPAC/src/gpac/_Filters/_TrainableBandPassFilter.py
# --------------------------------------------------------------------------------
