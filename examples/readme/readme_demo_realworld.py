...
"""Functions & Classes"""
def load_sample_eeg_data(data_path=None):
    ...
    sample_data_path = mne.datasets.sample.data_path(path=data_path)
...
def main(args):
    ...
    print("\n[CYAN] Loading MNE sample EEG data [/CYAN]\n")
    raw, events = load_sample_eeg_data(data_path=mne_data_path)
    print(f"Loaded {len(raw.ch_names)} EEG channels")
    print(f"Sampling frequency: {raw.info['sfreq']} Hz")
    
    # Preprocess data
    print("\n[CYAN] Preprocessing EEG data [/CYAN]\n")
    ...
    print("\n[CYAN] Computing PAC across channels [/CYAN]\n")
