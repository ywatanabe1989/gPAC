#!/usr/bin/env python3
"""
Example: Performance Profiling with gPAC
...
@mngs.plt.subplots(nrows=2, ncols=2, figsize=(12, 10), facecolor="white")
def visualize_profiling_results(fig, results):
...
def main():
    ...
    if results['batch_sizes']:
        ...
        report.append(f"")
        report.append(f"{'Batch Size':<12} {'Time (s)':<12} {'Memory (MB)':<12} {'Throughput':<12}")
        report.append(f"{'-'*48}")
