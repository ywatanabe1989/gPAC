#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Timestamp: "2025-06-09 19:22:53 (ywatanabe)"
# File: /ssh:ywatanabe@sp:/home/ywatanabe/proj/gPAC/examples/benchmark/parameter_sweep/parameter_sweep_benchmark.py
# ----------------------------------------
import os
__FILE__ = (
    "./examples/benchmark/parameter_sweep/parameter_sweep_benchmark.py"
)
...
def benchmark_one_condition(
    ...
    return calculation_time, sample_comodulogram
...
def compute(
    ...
    def _compute_gpac(dataloader, device, pac_calculator_gpac):
        ...
        with torch.no_grad():
            ...
            # print(signal.shape) # (batch_size, n_channels, n_segements, seq_pts)
    ...
    if package == "gpac":
        ...
        return _compute_tensorpac(dataloader, pac_calculator, n_perm, n_cpus)
    else:
