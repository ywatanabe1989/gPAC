...
class Profiler:
    ...
    def profile(self, name: str):
        ...
        self._active_profiles[name] = {
            ...
            "initial_stats": {**self._get_cpu_memory_stats(), **self._get_gpu_stats()},
        }
        ...
        try:
            ...
            # Get final stats
            final_stats = {**self._get_cpu_memory_stats(), **self._get_gpu_stats()}
    ...
    def get_summary_dict(self) -> Dict[str, Any]:
        ...
        if any(r.gpu_memory_used_gb is not None for r in self.results):
            ...
            if any(r.gpu_memory_reserved_gb is not None for r in gpu_results):
                summary["peak_vram_reserved_gb"] = max(
                    r.gpu_memory_reserved_gb
                    for r in gpu_results
                    if r.gpu_memory_reserved_gb is not None
                )
