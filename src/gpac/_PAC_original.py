#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Timestamp: "2025-05-25 11:50:02 (ywatanabe)"
...
class PAC(nn.Module):
    ...
    def forward(
        ...
        with grad_context:
            ...
            # 8. Segment averaging is already handled within ModulationIndex
            # No additional averaging needed here since result shape is (B, C, F_pha, F_amp)
