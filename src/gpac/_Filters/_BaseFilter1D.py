...
class BaseFilter1D(nn.Module):
    def __init__(self, fp16=False, in_place=False, padding_mode="reflect"):
        super().__init__()
        self.fp16 = fp16
    ...
    def forward(self, x, t=None, edge_len=0):
        ...
        # Filtering with configurable padding
        x = self.apply_padding(x, self.kernel_size // 2)
